...
struct DatedImageGeneratorExecutable {
    ...
    static func fileContent(for catalogPaths: [String], isForSwiftModule: Bool) throws -> String {
        ...
        let defaultCatalogName = "AssetCatalogImages"
        
        let catalogName: String
        if
            let firstCatalogPath = catalogPaths.first {
            let firstCatalogName = ((firstCatalogPath as NSString).deletingPathExtension as NSString).lastPathComponent
